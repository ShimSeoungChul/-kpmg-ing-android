        ...
        if(data.equals("ServerFail")){
            ...
            try {
                ...
                if (!rslt.equals("SUCC")) { //서버 통신 실패
                    ...
                    //통신 성공
                    Log.e(tag,"서버와에 값 정상적으로 전달");
                    Log.e(tag,"이미지 전처리 예시1:"+jsonObject.getString("0"));
                    Log.e(tag,"이미지 전처리 예시1:"+jsonObject.getString("1"));
                    Log.e(tag,"이미지 전처리 예시1:"+jsonObject.getString("2"));
                    Log.e(tag,"이미지 전처리 예시1:"+jsonObject.getString("3"));
